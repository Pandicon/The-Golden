...
| $,      | Sets the cell to the value of user input as a number (if they input 69, the cell value will be 69). It parses the longest prefix of the input that can be parsed to a number ("1.1a" -> 1.1)                                                                                           | `$,`                  | No         | Yes                     |
| ?$,     | Tries to parse the current user input into a number. If it fails, it breaks out of the current loop, else it sets the cell to the parsed value (if they input 69, the cell value will be 69). It parses the longest prefix of the input that can be parsed to a number ("1.1a" -> 1.1) | `$,`                  | No         | Yes                     |
